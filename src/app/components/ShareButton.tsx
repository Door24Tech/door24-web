  ...
  const shareOptions = [
    {
      ...
      action: () => {
        window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(fullUrl)}`, '_blank', 'width=550,height=420');
        setShowMenu(false);
      }
    },
    {
    ...
    <div className="relative">
      ...
      {showMenu && (
        <>
          ...
          {/* Menu */}
          <div className="absolute right-0 top-full mt-2 z-50 min-w-[180px] rounded-lg border border-[var(--door24-border)] bg-[var(--door24-background)] shadow-xl overflow-hidden backdrop-blur-sm">
