              ...
              >
                <div className="flex flex-col gap-4">
                  <div className="flex items-center justify-between">
                    <div className="rounded-lg bg-[var(--door24-primary-start)]/10 p-3 text-[var(--door24-primary-end)] transition-colors duration-300 group-hover:bg-[var(--door24-primary-start)]/20">
                      {card.icon}
                    </div>
                  </div>
                  <div className="flex flex-col gap-2">
